...
const Features = ({ featuresRef }) => {
  ...
  const featuresData = [
    ...
    },
    {
      ...
      description:
        "Set priority levels to focus on what matters most with our color-coded system.",
    },
    {
      icon: <IconLayoutGrid className="text-red-600" />,
      title: "Project Views",
      description:
        "Switch between list, board, and timeline views to visualize your projects your way.",
    },
    {
      icon: <IconUsers className="text-red-600" />,
      title: "Team Collaboration",
      description:
        "Assign tasks, share projects, and comment in real-time with your team members.",
    },
    {
      icon: <IconBellRinging className="text-red-600" />,
      title: "Smart Reminders",
      description:
        "Get intelligent reminders based on due dates, locations, and your work patterns.",
    },
    {
      icon: <IconChartBar className="text-red-600" />,
      title: "Productivity Analytics",
      description:
        "Track your completion rates and identify patterns to improve your workflow.",
    },
  ];
  ...
  return (
    <div ref={featuresRef} className="w-full py-12 px-4 md:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <Header
          ...
          description={
            "Discover the powerful tools designed to elevate your productivity. Seamlessly manage tasks, organize your work, and collaborate efficiently."
          }
        />
